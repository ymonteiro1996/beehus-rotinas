...
| `tests/test_dashboard.py` | dashboard | GET /api/rows returns `{rows, dates}` |
| `tests/test_issues.py` | issues | GET /api/issues/rows returns `{rows, date}` |
...
| `tests/test_precificacao.py` | precificacao | GET companies, wallets, search |
| `tests/test_precos.py` | precos | GET search, filters, history |
| `tests/test_impostos.py` | impostos | GET companies, wallets, securities |
| `tests/test_repeticao.py` | repeticao | GET companies, POST generate |
| `tests/test_report_builder.py` | report_builder | GET wallets, POST preview |
